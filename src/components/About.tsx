        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Kay is an artist based in Essex, UK, whose work captures a unique blend of contemporary
              ...
              <p>
                A graduate at The School of Arts in Oxford with a BA in Fine Art, her creative process is defined by exploration and experimentation. Kay’s work reflects a deep understanding of colour, form, and composition, achieved through a meticulous balance of digital tools and hand-rendered techniques. Each piece
